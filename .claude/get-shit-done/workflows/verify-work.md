...
Read and follow `D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/workflows/diagnose-issues.md
