...
```bash
INIT=$(node "D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
