...
```
Task(
  prompt="Read D:/ThaoCamVien/ThaoCamVien/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/templates/SECURITY.md`
