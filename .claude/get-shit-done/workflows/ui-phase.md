...
```markdown
Read D:/ThaoCamVien/ThaoCamVien/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/ThaoCamVien/ThaoCamVien/.claude/agents/gsd-ui-checker.md for instructions.
