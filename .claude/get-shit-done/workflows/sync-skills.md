...
INSTALL_JS_GLOBAL="D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
