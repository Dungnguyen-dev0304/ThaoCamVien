...
Reference full template: `D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/templates/state.md`.
