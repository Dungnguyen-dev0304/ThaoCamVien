...
<required_reading>
@D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/ThaoCamVien/ThaoCamVien/.claude
                  → checks D:/ThaoCamVien/ThaoCamVien/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done
                  → writes to D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/hooks/
...
@D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/references/common-bug-patterns.md
