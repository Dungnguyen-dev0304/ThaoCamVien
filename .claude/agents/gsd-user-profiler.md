...
<reference>
@D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/references/user-profiling.md` to load:
