...
<execution_context>
@D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @D:/ThaoCamVien/ThaoCamVien/.claude/get-shit-done/workflows/docs-update.md end-to-end.
