...
namespace ApiThaoCamVien.Migrations
{
    ...
    public partial class AddPaymentSystem : Migration
    {
        ...
        {
            migrationBuilder.DropTable(name: "premium_accesses");
            migrationBuilder.DropTable(name: "payment_transactions");
            migrationBuilder.DropColumn(name: "premium_price", table: "pois");
            migrationBuilder.DropColumn(name: "is_premium", table: "pois");
        }
    }
}
